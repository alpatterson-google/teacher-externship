import albertImage from '../../../assets/Lulu.png';

const PatrickMaestas = () => {
  return (
    <div className="max-w-sm mx-auto bg-white rounded-lg shadow-md overflow-hidden">
      <div className="p-6">
        <div className="flex flex-col items-center">
          ...
          />
          <h2 className="text-2xl font-bold text-green-800 mb-2">Patrick Maestas</h2>
          ...
          <div className="w-full space-y-2">
            ...
            <div className="flex justify-between items-center py-2">
              ...
              <span className="text-gray-800">ESL and Spanish Instructor</span>
            </div>
          </div>
