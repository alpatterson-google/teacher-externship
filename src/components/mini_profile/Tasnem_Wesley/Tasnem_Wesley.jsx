import albertImage from '../../../assets/Weird_Terrific.jpg';
    ...
    <div className="max-w-sm mx-auto bg-white rounded-lg shadow-md overflow-hidden">
      <div className="p-6">
        <div className="flex flex-col items-center">
          <img 
            src={albertImage} 
            alt="Terrific Tasnem and Weird Wes" 
            className="w-32 h-32 rounded-full object-cover mb-4 border-4 border-gray-200"
          />
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Terrific Tasnem and Weird Wes</h2>
          <p className="text-gray-600 text-center mb-4">
            Goodwill Excel Center Teachers 
          </p>
          <div className="w-full space-y-2">
            ...
            <div className="flex justify-between items-center py-2">
              ...
              <span className="text-gray-800">Superstar educators making the world a better place</span>
            </div>
          </div>
